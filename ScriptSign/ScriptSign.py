...
class MyFrame(wx.Frame):
    def __init__(self, parent, id):
        ...
        #===============================高级查询============================
        # self.classname = wx.StaticText(panel, label="class:", pos=(30, 140))
        # self.classname.SetFont(font)
        # self.classValue = wx.TextCtrl(panel,pos=(120,141),size=(110,-1),style=wx.TE_LEFT)
        # self.idname = wx.StaticText(panel, label="  id:", pos=(255, 140))
        # self.idname.SetFont(font)
        # self.idValue = wx.TextCtrl(panel, pos=(330, 141), size=(150, -1), style=wx.TE_LEFT)
        # self.typename = wx.StaticText(panel, label="type:", pos=(30, 180))
        # self.typename.SetFont(font)
        # self.typeValue = wx.TextCtrl(panel, pos=(120, 181), size=(110, -1), style=wx.TE_LEFT)
        # self.stylename = wx.StaticText(panel, label="style:", pos=(283, 180))
        # self.stylename.SetFont(font)
        # self.styleValue = wx.TextCtrl(panel, pos=(365, 181), size=(115, -1), style=wx.TE_LEFT)
        #
        # self.KeyA = wx.TextCtrl(panel, pos=(30, 221), size=(80, -1), style=wx.TE_LEFT)
        # self.sep = wx.StaticText(panel, label=":", pos=(120, 220))
        # self.sep.SetFont(font)
        # self.ValueA = wx.TextCtrl(panel, pos=(140, 221), size=(90, -1), style=wx.TE_LEFT)
        # self.KeyB = wx.TextCtrl(panel, pos=(280, 221), size=(80, -1), style=wx.TE_LEFT)
        # self.sepB = wx.StaticText(panel, label=":", pos=(370, 220))
        # self.sepB.SetFont(font)
        # self.ValueB = wx.TextCtrl(panel, pos=(390, 221), size=(90, -1), style=wx.TE_LEFT)
